...
func (e *Binance) RequestCandlesticks(marketSource common.MarketSource, startTimeTs int, intervalMinutes int) ([]common.Candlestick, error) {
	e.lock.Lock()
	defer e.lock.Unlock()
...
func (e *Binance) GetPatience() time.Duration { return 0 * time.Minute }
